...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا بيك يا  {mention} **\
                        \n**⌔︙ {my_mention}'انا البوت المساعد .**\
                        \n**⌔︙ يمكنك التواصل مع صاحب البوت فقط ارسل رسالتك 👤.**\
                        \n\n**⌔︙ البوت خاص بسورس :** [TELETHON JOKER7x](https://t.me/J0KER_7x)"
        buttons = [
            (
                Button.url("لتنصيب سورسنا", "https://t.me/J0KER_7x"),
                Button.url(
                    "𓆩 آݪــمــبــرمــج ݪــيدو 𓆪",
                    "https://t.me/J0KER7x",
                ),
            )
        ]
