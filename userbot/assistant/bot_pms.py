    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋🏻 ⁞ مرحبا يا  {mention} **\
                        \n**👋🤖 ⁞ {my_mention}'انا بوت تليثون **\
                        \n** 🗯 ⁞ ارسل رسالتك الان لكي يتم ارسالها الى مدير البوت.**\
                        \n\n**🕕 ⁞ سوف يرد عليك باقرب وقت "
        buttons = [
            (
                Button.url("للتنصيب ", "https://t.me/SO_SELVA/4015"),
                Button.url(
                    "{𝚂𝙾𝚄𝚁𝙲𝙴}.𝚂𝙴𝙻𝚅𝙰",
                    "https://t.me/SO_SELVA",
                ),
        ...
        start_msg = "**🧑🏻‍✈️︙اهلا بك بك عزيزي المطور ♥️**\
            \n⤵️ ⁞ لمعرفة الاوامر الخاصة بيك اضغط :» /Lido"
        buttons = None
    try:
