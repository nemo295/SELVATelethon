...
async def do_pm_permit_action(event, chat):  
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝑱𝑶𝑲𝑬𝑹7𝑿 𝑻𝑬𝑨𝑴  ⏎ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n\n❞ هلو ماي فريند {mention} ❝ 🤍\n~ يمكن نايم أو مشغول  \n ~ سيب رسالتك وهرد عليك ف اقرب وقت . \n~ هيكون عندك 10 رسائل فقط .\n~ بعديها البوت هيحظرك خلي بالك 😂\n❞ يلا باي 😂 {mention} ❝ 🤍\n ⤶ ❨  `{warns}/{totalwarns}` ❩\n\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝑱𝑶𝑲𝑬𝑹7𝑿 𝑻𝑬𝑨𝑴  ⏎ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
    else:
        USER_BOT_NO_WARN = f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝑱𝑶𝑲𝑬𝑹7𝑿 𝑻𝑬𝑨𝑴  ⏎ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n\n❞ هلو ماي فريند {mention} ❝ 🤍\n~ يمكن نايم أو مشغول  \n ~ سيب رسالتك وهرد عليك ف اقرب وقت . \n~ هيكون عندك 10 رسائل فقط .\n~ بعديها البوت هيحظرك خلي بالك 😂\n❞ يلا باي 😂 {mention} ❝ 🤍\n ⤶ ❨  `{warns}/{totalwarns}` ❩\n\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝑱𝑶𝑲𝑬𝑹7𝑿 𝑻𝑬𝑨𝑴  ⏎ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
