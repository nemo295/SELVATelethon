...
UPDATE = gvarstatus("OR_UPDATE") or "(اعاده تشغيل|حدث|تحديث)"
ORDERS = gvarstatus("OR_ORDERS") or "(اوامري|أوامري|م)"
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/57b7b60b22dee3fc3b317.mp4"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/57b7b60b22dee3fc3b317.mp4"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "Welcome Telethon JOKER7x"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/57b7b60b22dee3fc3b317.mp4"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون جوكر - Telethon-JOKER7X ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"☭︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @vars_thonjoker7x :**\n\n{o}")
...
async def _(event):
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "**⌯︙   جاري... تحديث سورس تليثون جوكر ↻**")
    sandy = await edit_or_reply(event , "⌯︙ بدا تـحديـث تـليثون جوكر سفن اكس  🔄\n⌯︙ استني من 2 - 5 دقايق يتحدث \n⌯︙ تحديث 3 مـرات باليـوم فقط " ,)
    try:
...
https://t.me/vars_thonjoker7x

قناة الكلايش  : @ClashJOKER7X
قناه شروحات الاوامر  : @J0KER_7x
قناه  الفارات : @vars_thonjoker7x""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**☭︙  📑 يرجى متابع قناه الفارات  : @vars_thonjoker7x")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://t.me/J0KER_7x"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://t.me/TerMux_7xBOT"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/JOKER-7X/Helper"),],[Button.url("👨🏻‍💻المبرمج ليدو👨🏻‍💻🏼‍💻", "https://t.me/J0KER7x"),]]
...
async def iq(event):
    await edit_or_reply(event, """⌯⦙  ⦗ اوامـر سـورس تـليثون جوكر سفن اكس ⦘
                                             ✦┅━╍━╍╍━━╍━━╍━┅✦
`.م1`◂ اوامر الحساب 1
`.م2`◂ اوامر الحساب 2
`.م3` ◂  اوامر الحساب 3
...
`.م31` ◂ اوامر الملصقات
                                               ✦┅━╍━╍╍━━╍━━╍━┅✦
اضغط علي رقم اوامر  لنسخ الامر ولصق لاضهار قائمة الاوامر خاصة برقم الاوامر
لـمعرف تغير الفارات او تغير متغيرات السورس ارسل ⏎ 〖`.مساعده`〗""")
@iqthon.on(admin_cmd(pattern="م9(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, "**🚹  ⦑   اوامر الالعاب 1   ⦒  :**\n\n ✦┅━╍━╍╍━━╍━━╍━┅✦ \n**⑴  ⦙  نسب وهميه :**\n`.نسبه الحب + الرد ع الشخص`\n`. نسبه الانحراف + الرد ع الشخص `\n`.نسبه الكراهيه + الرد ع الشخص`\n`.نسبه المثليه +الرد ع الشخص`\n`. نسبه النجاح + الرد ع الشخص`\n`.نسبه الانوثه + الرد ع الشخص `\n`.نسبه الغباء + الرد ع الشخص`\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n**⑵  ⦙  رفع وهمي :**\n`.رفع زباله + الرد ع الشخص `\n`.رفع منشئ + الرد ع الشخص `\n`.رفع مدير + الرد ع الشخص`\n`.رفع مطور + الرد ع الشخص` \n`.رفع مثلي + الرد ع الشخص` \n`.رفع كواد + الرد ع الشخص` \n`.رفع مرتبط + الرد ع الشخص` \n`.رفع مطي + الرد ع الشخص` \n`.رفع كحبه + الرد ع الشخص` \n`.رفع زوجتي + الرد ع الشخص` \n`.رفع صاك + الرد ع الشخص` \n`.رفع صاكه + الرد ع الشخص`\n✦┅━╍━╍╍━━╍━━╍━┅✦n⑶  ⦙ `.كت`\n**✐ : لعبه اسأله كت تويت عشوائيه ❝**\n⑷  ⦙ `.اكس او` \n**✐ :  لعبه اكس او دز الامر و اللعب ويا صديقك ❝**\n⑸  ⦙  `.همسه + الكلام + معرف الشخص` \n**✐ : يرسل همسه سريه الى معرف الشخص فقط هو يكدر يشوفها  ❝**\n")
@iqthon.on(admin_cmd(pattern="المبرمج(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, "**𓆩 SOURCE JOKER7𝚇 𓆪\n✛━━━━━━━━━━━━━✛\n🔺￤ 𓆩 ❥آݪــمــبــرمــج ݪــيدو 𓆪  : @J0KER7x\n🔺￤ قناة السورس :  @J0KER_7x\n🔺￤ جروب الدعم :  @joker7x_chat\n✛━━━━━━━━━━━━━✛**")
@iqthon.on(admin_cmd(pattern="المطور(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, "**𓆩 SOURCE JOKER7𝚇 𓆪\n✛━━━━━━━━━━━━━✛\n🔺￤ 𓆩 ❥آݪــمـطورة شاهي 𓆪  : @shahebrahem\n🔺￤ قناة السورس :  @J0KER_7x\n🔺￤ جروب الدعم :  @joker7x_chat\n✛━━━━━━━━━━━━━✛**")
...
async def inlineiqthon(iqthon):
    text = "**🚹  ⦑   اوامر الجروب   ⦒  :**"
    buttons = [[Button.inline("اوامر الجروب 1", data="G1"),],[Button.inline("اوامر الجروب 2", data="G2"),],[Button.inline("اوامر الجروب 3", data="G3"),],[Button.inline("اوامر الجروب 4", data="G4"),],[Button.inline("اوامر الجروب 5", data="G5"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)

@iqthon.tgbot.on(CallbackQuery(data=re.compile(rb"G1")))
@check_owner
async def inlineiqthon(iqthon):
    text = "**🚹  ⦑  اوامر الجروب 1     ⦒  :**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑴  ⦙ `.كتم + الرد ع الشخص`\n**✐ : يكتم الشخص من الخاص او الجروبات فقط اذا كانت عندك صلاحيه حذف رسائل ❝**\n \n⑵  ⦙ `. الغاء كتم + الرد ع الشخص`\n**✐ :  يجلب لك جميع معرفات المشرفين في الجروب  ❝**\n ✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑶  ⦙ `.البوتات`\n**✐ : يجلب لك جميع معرفات البوتات في الكروب ❝**\n \n⑷  ⦙ `.الأعضاء`\n**✐ : اضهار قائمة الاعضاء للكروب اذا هواي سيرسل ملف كامل لمعلوماتهم  ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n⑸  ⦙ `.معلومات`\n**✐ : سيرسل لك جميع معلومات الجروب بالتفصيل ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑹ ⦙ `.مسح المحظورين`\n**✐ : يمسح جميع المحظورين في الكروب ❝**\n ✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑺ ⦙ `.المحذوفين`\n**✐ : يجلب لك جميع الحسابات المحذوفه ❝**\n\n⑻ ⦙ `.المحذوفين تنظيف`\n**✐ : يمسح جميع الحسابات المحذوفه في الكروب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑼ ⦙ `.احصائيات الاعضاء`\n**✐ : يمسح جميع المحظورين في الكروب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑽ ⦙ `.انتحال + الرد ع الشخص`\n**✐ : يقوم بأنتحال الشخص ويضع صورته ونبذته واسمه في حسابك عدا المعرف ❝**\n\n⑾ ⦙ `.الغاء الانتحال + الرد ع الشخص`\n**✐ : يقوم بألغاء الانتحال وسيرجع معلومات المذكوره بالسورس ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n"
    buttons = [[Button.inline("اوامر الجروب 2", data="G2"),],[Button.inline("اوامر الجروب 3", data="G3"),],[Button.inline("اوامر الجروب 4", data="G4"),],[Button.inline("اوامر الجروب 5", data="G5"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🚹  ⦑   اوامر الجروب 2   ⦒  :**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑴  ⦙  `.ترحيب + الرساله` \n**✐ : يضيف ترحيب في الجروب اي شخص ينضم راح يرحب بي  ❝**\n⑵  ⦙   `.مسح الترحيبات` \n**✐ :  ييقوم بمسح الترحيب من الجروب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n  ⦙  `.ترحيباتي` \n**✐ :  يضهر لك جميع الترحيبات التي وضعتها في الكروب ❝**\n⑷  ⦙ `.رساله الترحيب السابقه تشغيل`  \n**✐ :  عندما يحدث تكرار سيحذف رساله الترحيب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑸  ⦙  `.رساله الترحيب السابقه ايقاف`\n**✐ :  عندما يحدث تكرار لا يحذف رساله الترحيب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑹ ⦙  `.اضف رد + الكلمه` \n**✐ :  مثلاً تدز رساله هلو تسوي عليها رد بهلوات ❝**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑺ ⦙ `.مسح رد + الكلمه` \n**✐ :  سيحذف الكلمه الي انت ضفتها ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n⑻ ⦙  `.جميع الردود` \n **✐ :  يجلب لك جميع الردود الذي قمت بأضافتها  ❝**\n⑼ ⦙  `.مسح جميع الردود` \n**✐ :  يمسح جميع الردود الي انت ضفتها ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑽ ⦙  `.صنع مجموعه + اسم المجموعه`\n**✐ : يقوم بعمل مجموعه خارقه ❝**\n \n⑾ ⦙  `.صنع قناه +  اسم القناة`\n**✐ : يقوم بعمل قناه خاصه  ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑿ ⦙ `.عدد رسائلي`\n**✐ : سيظهر لك عدد رسائلك في الكروب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n"
    buttons = [[Button.inline("اوامر الجروب 1", data="G1"),],[Button.inline("اوامر الجروب 3", data="G3"),],[Button.inline("اوامر الجروب 4", data="G4"),],[Button.inline("اوامر الجروب 5", data="G5"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)
...
async def inlineiqthon(iqthon):
    text = "**🚹  ⦑   اوامر الجروب 3   ⦒  :**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑴  ⦙  `.تفعيل حمايه المجموعه`\n**✐ : يقوم غلق جميع صلاحيات المجموعه يبقي فقط ارسال  الرسائل❝**\n \n⑵  ⦙ `تعطيل حمايه المجموعه`\n**✐ :  يقوم بتشغيل جميع صلاحيات المجموعة ماعدا تغير المعلومات و التثبيت و اضافه اعضاء تبقى مسدوده❝**\n\n⑶  ⦙ `.صلاحيات المجموعه`\n**✐ : يقوم بعرض صلاحيات المجموعه المغلقه والمفتوحه❝**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦\n⑷  ⦙  `.رفع مشرف + الرد على شخص`\n**✐ : يرفع الشخص مشرف يعطي صلاحيه حذف رسائل والتثبيت فقط❝**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑸  ⦙ `.منع + كلمة`\n**✐ : منع كلمه من الارسال في الكروب**❝\n⑹ ⦙ `.الغاء منع + كلمه`\n**✐ : يقوم بالغاء منع الكلمه ❝** \n⑺ ⦙ `.قائمه المنع`\n**✐ : يقوم بجلب جميع الكلمات الممنوعه في الكروب ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑻ ⦙ ` .تاك + ( الاعداد المحدده وثابتة فقط) ⤵️`\n  ( 10 - 50 - 100 - 200  )\n**✐ : يجلب لك الاعضاء بالروابط بالعدد المحدد ❝**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⑼ ⦙ `.معرفات + ( الاعداد المحدده وثابتة فقط) ⤵️`\n  ( 10 - 50 - 100 - 200  )\n**✐ :جلب لك معرفات الاعضاء بالعدد المحدد ❝**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦\n"
    buttons = [[Button.inline("اوامر الجروب 1", data="G1"),],[Button.inline("اوامر الجروب 2", data="G2"),],[Button.inline("اوامر الجروب 4", data="G4"),],[Button.inline("اوامر الجروب 5", data="G5"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)
...
async def inlineiqthon(iqthon):
    ...
    buttons = [[Button.inline("اوامر الجروب 1", data="G1"),],[Button.inline("اوامر الجروب 2", data="G2"),],[Button.inline("اوامر الجروب 3", data="G3"),],[Button.inline("اوامر الجروب 5", data="G5"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)
@iqthon.tgbot.on(CallbackQuery(data=re.compile(rb"G5")))
@check_owner
async def inlineiqthon(iqthon):
    text = "**🚹  ⦑  اوامر الجروب 5     ⦒  :**\n\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑴  ⦙ `.تحذير التكرار + عدد رسائل`\n**✐ :  اي شخص بلكروب يكرر رسائل مالته بلعدد المحدد يقيدة مهما كان رتبته**\n ⑵  ⦙ ` .تحذير تكرار 99999 `\n✐ :  هذا الامر ستعمله من تريد تلغي التحذير لان مستحيل احد يكرر هل عدد ف اعتبار ينل(غي التحذير**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑶  ⦙ ` .حظر + الرد على شخص`\n✐ : حظر الشخص من المجموعه او الجروب**\n ⑷  ⦙ ` .الغاء الحظر + الرد على شخص`\n✐ :  يلغي حظر الشخص من المجموعه او الجروب**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑸  ⦙ ` .بدء مكالمه `\n✐ :  يقوم بتشغيل مكالمه في المجموعه**\n ⑹  ⦙ `.دعوه للمكالمه`\n✐ : يتم دعوه الاعضاء للمكالمة الشغاله**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⑺  ⦙ ` .تنزيل مشرف + الرد على شخص`\n✐ :  يقوم بازاله الشخص من الاشراف **\n ⑻  ⦙ ` .تثبيت + الرد على رساله`\n✐ : شرح : تثبيت الرساله التي رديت عليها**⒀  ⦙ `.الأعضاء`\n**✐ :  اضهار قائمة الاعضاء للمجموعة اذا هواي يرسلك ملف كامل لمعلوماتهم**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n⒁  ⦙ `.تفليش `\n**✐ :  يقوم بأزاله جميع اعضاء المجموعه او القناة الى 0**\n✦┅━╍━╍╍━━╍━━╍━┅✦ \n ⒂  ⦙ `.مسح المحظورين`\n**✐ :  يمسح جميع المحظورين في المجموعه او القناه **\n⒃  ⦙ `.المحذوفين`\n**✐:  يجلب لك جميع الحسابات المحذوفه في المجموعه او القناه**\n⒄  ⦙ `.المحذوفين تنظيف`\n**✐ :  مسح جميع الحسابات المحذوفه في المجموعه او القناة**\n⒅  ⦙ `.احصائيات الاعضاء`\n**✐ :  يرسل اليك جميع معلومات اعضاء المجموعه منها عدد الحسابات المحذوفه او الحسابات النشطه او الحسابات اخر ضهور وجميعهم**\n⒆  ⦙ `.عدد رسائلي`\n**✐ : يقوم بحساب عدد رسائلك في المجموعه او القناة**\n⒇  ⦙ `.جلب الاحداث`\n**✐ :  يرسل اليك اخر 20 رساله محذوفه في المجموعة من الاحداث**"
    buttons = [[Button.inline("اوامر الجروب 1", data="G1"),],[Button.inline("اوامر الجروب 2", data="G2"),],[Button.inline("اوامر الجروب 3", data="G3"),],[Button.inline("اوامر الجروب 4", data="G4"),],[Button.inline("رجوع", data="orders"),]]
    await iqthon.edit(text, buttons=buttons)
...
async def repoiqthon(iqthon):
    ...
    if iqthon.reply_to_msg_id:
        await iqthon.get_reply_message()
    response = await bot.inline_query(TG_BOT, "اوامر الجروب(?: |$)(.*)")
    await response[0].click(iqthon.chat_id)
    await iqthon.delete()
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    @check_owner
