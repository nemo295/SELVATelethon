...
kno = [    "100% تحبك وتخاف عليك",    "100% يحبك ويخاف عليك",    "91% جـزء من قـلبه ",    "81% تموت عليك دي ",    "81% يموت عليك ههذا ",    "هاه اخي ؟  🏳‍🌈",    "40% واحد حيوان ومصلحه  ",    "50% شوف ماله بيك ",    "30% خاين نصحية فكك منه ",    "25% مصادق غيرك ويقولك احبك",    "25% واحد كلب ابن كلب يسيبه",    "0% مش بيحبك ",    "0% تكرهك ",    "@J0KER_7x",]
...
async def _(event):
    ...
    event = await edit_or_reply(event, "**ارمي عقلك في زبالة **")
    animation_chars = [
        "**- عقلك** ➡️ 🧠\n\n🧠         <(^_^ <)🗑",
        "**- عقلك** ➡️ 🧠\n\n🧠       <(^_^ <)  🗑",
        "**- عقلك** ➡️ 🧠\n\n🧠     <(^_^ <)    🗑",
...
async def _(event):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",    ]
    event = await edit_or_reply(event, "طب..طب طب..طب طب طب..بتبص علي اي")
...
async def _(event):
    ...
    await event.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await event.edit("🔥🔥🔥اشوفها بتولع دلوقتي 😹 $$ ولع يبني 🔥🔥🔥") 
...
@iqthon.on(admin_cmd(pattern="وعد(?: |$)(.*)"))
async def _(event):
    "أمر الرسوم المتحركة"
    animation_interval = 3
    animation_ttl = range(32)
    event = await edit_or_reply(event, "وعد 🖇❤️‍🔥")
    animation_chars = [
        "🙂🖇🙂\n  👱🏻‍♂️  =====> اوعديني",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> اوعدك ب ايه😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> لو زعلتي مني مره تعرفيني",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> هحاول😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> لو جرحتك غصب عني تحسسيني💝",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> طيب😂 ",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> متشليش جواكي حاجه💕",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> والله ممعيش كيس اشيل في😂😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> تحكي ليا كل حاجه💘",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> ليه صحبتي😂💔",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> لما افهم هبقي احسن صدقيني💙",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> ماشي😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> اوعديني❤️",
 "🙂🙂🖇\n  👱🏻‍♀️  =====> انت تاني انجز😂😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> لو نسيت يا حبيبتي نفسي تفوقيني💓",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> بس كده ياسلام عنيا😂😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> لو خدتني الدنيا منك ترجعيني❣️",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> لا مبرجعش حد انا😁😂 ",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> لو في لحظه زاد غروري🖤",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> ايوه اعمل اي بقا😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> اشتكي و لومي وثوري😍",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> اشطا سهله دي😂😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> بس اوعي في يوم تروحي وتسبيني💋",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> علي حسب بصراحه😂",
       "🙂🖇🙂\n  👱🏻‍♂️  =====> انتي قلبي وانتي روحي وانتي عيني💗",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> الله يكرم اصلك احم بؤحرج انا😂😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> انتي حد عاوز اعيش معاه لاخر سنيني💞",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> هفكر في الموضوع ده😂",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> انتي بالنسبالي مش حب في حياتي وبس😘",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> نعم ياخويا😂😂 ",
        "🙂🖇🙂\n  👱🏻‍♂️  =====> انتي كل حياتي فعلاً افهميني🤍",
        "🙂🖇🙂\n  👱🏻‍♀️  =====> طب ماتقول كده من الاول😂😂",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def _(event):
    ...
    animation_chars = [
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[مشغل موسيقى](tg://user?id=916234223)\n\n⠀⠀⠀⠀**التشغيل الآن : شكل**\n\n**00:00** ▱▱▱▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀ `🔂` `⏮️` `⏪️` `▶️` `⏩️` `⏭️`\n\n**الأغنية التالية : مكانك في قلبي - عمرو دياب  **",
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[مشغل موسيقى](tg://user?id=916234223)\n\n⠀⠀⠀⠀**التشغيل الآن : شكل**\n\n**00:01** ▰▱▱▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀ `🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**الأغنية التالية : مكانك في قلبي - عمرو دياب  **",
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[مشغل موسيقى](tg://user?id=916234223)\n\n⠀⠀⠀⠀**التشغيل الآن : شكل**\n\n**00:02** ▰▰▱▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**الأغنية التالية : مكانك في قلبي - عمرو دياب  **",
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[مشغل موسيقى](tg://user?id=916234223)\n\n⠀⠀⠀⠀**التشغيل الآن : شكل**\n\n**00:03** ▰▰▰▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀ `🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**الأغنية التالية : مكانك في قلبي - عمرو دياب  **",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀ [مشغل موسيقى](tg://user?id=916234223)\n\n⠀⠀⠀⠀**التشغيل الآن : شكل**\n\n**00:04** ▰▰▰▰▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n** الأغنية التالية : مكانك في قلبي - عمرو دياب  **",
...
@iqthon.on(admin_cmd(pattern="كتكوتي(?: |$)(.*)"))
async def _(event):
    "أمر الرسوم المتحركة"
    event = await edit_or_reply(event, "**كتكوتي..**")
    deq = deque(list("🐣✨🐣✨🐣✨🐣✨"))
    for _ in range(45):
        await asyncio.sleep(0.3)
        await event.edit("".join(deq))
...
@iqthon.on(admin_cmd(pattern="كتكوت(?: |$)(.*)"))
async def _(event):
    "أمر الرسوم المتحركة"
    event = await edit_or_reply(event, "**كتكوت..**")
    deq = deque(list("🐣🐥🐣🐥🐣🐥🐣🐥"))
    for _ in range(45):
        await asyncio.sleep(0.3)
        await event.edit("".join(deq))
...
async def _(event):
    event = await edit_or_reply(event, "اسعاف في طريق ...")
...
@iqthon.on(admin_cmd(pattern="حريقه(?: |$)(.*)"))
async def _(event):
    "أمر الرسوم المتحركة"
    event = await edit_or_reply(event, "حريقه")
    deq = deque(list("💥🔥💥🔥💥🔥💥🔥"))
    for _ in range(20):
        await asyncio.sleep(0.2)
        await event.edit("".join(deq))
...
@iqthon.on(admin_cmd(pattern="زعلان(?: |$)(.*)"))
async def _(event):
    "أمر الرسوم المتحركة"
    event = await edit_or_reply(event, "زعلان")
    deq = deque(list("😕😞🙁☹️😕😞🙁"))
    for _ in range(20):
        await asyncio.sleep(0.2)
        await event.edit("".join(deq))
...
async def permalink(mention):
    ...
    if user.id == 776886547:
        return await edit_or_reply(mention, f"**- ده مبرمج السورس  يا عبيط 😂😂😂  **")
...
@iqthon.on(admin_cmd(pattern="نونو(?: |$)(.*)"))
async def _(event):
    "متعة الرسوم المتحركة"
    catevent = await edit_or_reply(event, "**جاري جلب كتكوت نونو🐣**")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🐥       🐥", "🐥     🐥", "🐥  🐥", "🐥🐣🐥"]
    for i in animation_ttl:
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 776886547:
            await edit_or_reply(
                event, "**⌔︙   ده مبـرمج السـورس لايـمكن تهكيـره يا عبيط 🙂😂 . ⚜️**"
            )
        else:
...
hanhi = [    "تف عليك ياخايس",    "كرامتك وين ياقندره",    "تعال كواد اليوم طيزك اشكه ",    "هاه اخي ؟",    "واحد حيوان ومصلحه عوفه ",    "لك حيوان كواد استقر لك",
    " وخر ماسوي شي",    "مااهين حيوانات اني",    "واحد كلب ابن كلب عوفه",    "دعوفه هوه يحصرون بيه وره السده هذا ",    "خطيه هذا مبدلين عقله وحاطين طيزه",    "@J0KER_7x",]
...
async def iq(mention):
    ...
    if not user:
        return
    if user.id == 776886547:
        return await edit_or_reply(mention, f"**- ده مبرمج السورس  يا هبل 😂😂😂 **")
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        idd = reply_message.sender_id
        if idd == 776886547:
            await catevent.edit(                "- ده مبرمج السورس  يا هبل 😂😂😂"            )
        else:
